...
- [Offline UX Patterns](#offline-ux-patterns)
  - [Contents](#contents)
  - [How Offline State Is Detected](#how-offline-state-is-detected)
  - [Motivation \& Philosophy](#motivation--philosophy)
  - [Descriptions of the UX Patterns](#descriptions-of-the-ux-patterns)
    - [None - No Offline Behavior](#none---no-offline-behavior)
    - [A - Optimistic Without Feedback Pattern](#a---optimistic-without-feedback-pattern)
    - [B - Optimistic WITH Feedback Pattern](#b---optimistic-with-feedback-pattern)
    - [C - Blocking Form UI Pattern](#c---blocking-form-ui-pattern)
    - [D - Full Page Blocking UI Pattern](#d---full-page-blocking-ui-pattern)
  - [UX Pattern Flow Chart](#ux-pattern-flow-chart)
...
Understanding the offline behavior of our app is vital to becoming a productive contributor to the Kiroku codebase. Our mission is to support our users in every possible environment, and often our app is used in places where a stable internet connection is not guaranteed.
...
![Kiroku Data Flow Chart](/contributingGuides/OfflineUX_Patterns_Flowchart.png)
