...
| watchOS in-app logo            | `ios/Kiroku Watch App/Assets.xcassets/AppImage.imageset/AppImage{,@2x,@3x}.png` + `Contents.json` (start-screen tap target, same render as the app icon)                    |
