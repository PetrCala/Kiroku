...
| **Photos** (User Content)                  | Yes                 | No        | App Functionality (profile picture)      | `src/components/UploadImage.tsx`, `src/libs/actions/Image.ts` (`uploadImage` -> kiroku-api image pipeline)                                                                                                                                                                                                                                                                  |
