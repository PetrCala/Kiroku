...
//   return (
//     (sessionParam?.authTokenType ?? session.authTokenType) ===
//     CONST.AUTH_TOKEN_TYPES.ANONYMOUS
//   );
// }

// function hasStashedSession(): boolean {
//   return Boolean(
//     stashedSession.authToken &&
//       stashedCredentials.autoGeneratedLogin &&
//       stashedCredentials.autoGeneratedLogin !== '',
//   );
// }
...
//   API.write(WRITE_COMMANDS.REQUEST_ACCOUNT_VALIDATION_LINK, params, {
//     optimisticData,
//     successData,
//     failureData,
//   });
...
//   API.write(WRITE_COMMANDS.REQUEST_NEW_VALIDATE_CODE, params, {
//     optimisticData,
//     finallyData,
//   });
// }
...
//           isLoading: false,
//           loadingForm: null,
//           errors: ErrorUtils.getMicroSecondOnyxError(
//             'loginForm.cannotGetAccountDetails',
//           ),
//         },
//       },
//     ],
...
//   API.read(READ_COMMANDS.BEGIN_SIGNIN, params, {
//     optimisticData,
//     successData,
//     failureData,
//   });
...
//   API.write(WRITE_COMMANDS.SIGN_IN_WITH_APPLE, params, {
//     optimisticData,
//     successData,
//     failureData,
//   });
...
//   API.write(WRITE_COMMANDS.SIGN_IN_WITH_GOOGLE, params, {
//     optimisticData,
//     successData,
//     failureData,
//   });
...
//   const oldPartnerUserID =
//     credentials.login === email && credentials.autoGeneratedLogin
//       ? credentials.autoGeneratedLogin
//       : '';
//   API.read(
//     READ_COMMANDS.SIGN_IN_WITH_SHORT_LIVED_AUTH_TOKEN,
//     {authToken, oldPartnerUserID, skipReauthentication: true},
//     {optimisticData, finallyData},
//   );
// }
...
//         ...CONST.DEFAULT_ACCOUNT_DATA,
//         isLoading: true,
//         loadingForm: twoFactorAuthCode
//           ? CONST.FORMS.VALIDATE_TFA_CODE_FORM
//           : CONST.FORMS.VALIDATE_CODE_FORM,
//       },
//     },
//   ];
...
// ) {
//   Log.info('[PusherAuthorizer] Attempting to authorize Pusher', false, {
//     channelName,
//   });
...
//         Log.hmmm(
//           '[PusherAuthorizer] Unable to authenticate Pusher because authToken is expired',
//         );
//         callback(
//           new Error(
//             'Pusher failed to authenticate because authToken is expired',
//           ),
//           {auth: ''},
//         );
...
//         Log.hmmm(
//           '[PusherAuthorizer] Unable to authenticate Pusher for reason other than expired session',
//         );
//         callback(
//           new Error(
//             `Pusher failed to authenticate because code: ${response?.jsonCode} message: ${response?.message}`,
//           ),
//           {auth: ''},
//         );
//         return;
...
//       Log.info('[PusherAuthorizer] Pusher authenticated successfully', false, {
//         channelName,
//       });
...
//   API.write(WRITE_COMMANDS.REQUEST_UNLINK_VALIDATION_LINK, params, {
//     optimisticData,
//     successData,
//     failureData,
//   });
...
//   API.write(
//     enable
//       ? WRITE_COMMANDS.ENABLE_TWO_FACTOR_AUTH
//       : WRITE_COMMANDS.DISABLE_TWO_FACTOR_AUTH,
//     {},
...
//   API.write(WRITE_COMMANDS.TWO_FACTOR_AUTH_VALIDATE, params, {
//     optimisticData,
//     successData,
//     failureData,
//   });
...
//         const url = NativeModules.HybridAppModule
//           ? Navigation.parseHybridAppUrl(exitTo)
//           : (exitTo as Route);
...
//     routeRemovedReportId = route.replace(
//       (parsedReportRouteParams as {reportID: string})?.reportID,
//       ':reportID',
//     );
//   }
//   if (route.startsWith('/')) {
...
//     ROUTES.REPORT_WITH_ID_DETAILS.route,
//     ROUTES.REPORT_WITH_ID_DETAILS_SHARE_CODE.route,
//     ROUTES.CONCIERGE,
//   ];
//   const isMagicLink = CONST.REGEX.ROUTES.VALIDATE_LOGIN.test(`/${route}`);

//   if (
//     (routesAccessibleByAnonymousUser as string[]).includes(
//       routeRemovedReportId,
//     ) ||
//     isMagicLink
//   ) {
//     return true;
