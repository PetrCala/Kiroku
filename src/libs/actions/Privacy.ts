 ...
 * toggle). No optimistic Onyx data — data-visibility hydrates into Onyx
 * (`DATA_VISIBILITY`) via `app/open` + kiroku-api updates, mirroring the server
 * route's empty `onyxData`.
 */
