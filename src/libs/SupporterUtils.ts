...
/**
 * Whether Supporter-tier (subscription) UI should be rendered in this build.
 *
 ...
 * render the subscription surfaces. Flip this on for v1.1 by adjusting the
 * gate or by introducing a dedicated env flag; see the helper body.
 *
 * This does NOT gate the Support Kiroku screen itself: the screen is visible
 * in every build because it carries the tip jar (consumable IAPs, see
 * contributingGuides/TIP_JAR.md), which is deliberately independent of the
 * supporter tier. Only the paywall/subscription parts hide behind this.
 *
