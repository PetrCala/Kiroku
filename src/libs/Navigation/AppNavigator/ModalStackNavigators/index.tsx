...
const DrinkingSessionModalStackNavigator =
  createModalStackNavigator<DrinkingSessionNavigatorParamList>({
    ...
    [SCREENS.DRINKING_SESSION.SESSION_NAME_SCREEN]: () =>
      require<ReactComponentModule>('@screens/DrinkingSession/SessionNameScreen')
        .default,
    ...
    [SCREENS.DRINKING_SESSION.SESSION_TIMES_SCREEN]: () =>
      require<ReactComponentModule>('@screens/DrinkingSession/SessionTimesScreen')
        .default,
...
const SettingsModalStackNavigator =
  createModalStackNavigator<SettingsNavigatorParamList>({
    ...
    [SCREENS.SETTINGS.NOTIFICATIONS]: () =>
      require<ReactComponentModule>('@screens/Settings/NotificationsScreen')
        .default,
