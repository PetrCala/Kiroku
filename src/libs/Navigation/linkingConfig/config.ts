...
const config: LinkingOptions<RootStackParamList>['config'] = {
  ...
  screens: {
        ...
        [SCREENS.RIGHT_MODAL.DRINKING_SESSION]: {
          screens: {
            ...
            [SCREENS.DRINKING_SESSION.SESSION_NAME_SCREEN]: {
              path: ROUTES.DRINKING_SESSION_SESSION_NAME_SCREEN.route,
            },
            [SCREENS.DRINKING_SESSION.SESSION_NOTE_SCREEN]: {
              path: ROUTES.DRINKING_SESSION_SESSION_NOTE_SCREEN.route,
            },
            [SCREENS.DRINKING_SESSION.SESSION_TIMES_SCREEN]: {
              path: ROUTES.DRINKING_SESSION_SESSION_TIMES_SCREEN.route,
            },
        ...
        [SCREENS.RIGHT_MODAL.SETTINGS]: {
          screens: {
            ...
            [SCREENS.SETTINGS.PREFERENCES.COLOR_PALETTE_CUSTOM]: {
              path: ROUTES.SETTINGS_COLOR_PALETTE_CUSTOM,
              exact: true,
            },
            ...
            [SCREENS.SETTINGS.SUBSCRIPTION_TERMS]:
              ROUTES.SETTINGS_SUBSCRIPTION_TERMS,
    ...
    [NAVIGATORS.SESSIONS_CALENDAR_NAVIGATOR]: {
      screens: {
