...
- **Address the user with vykání** — formal 2nd-person plural ("máte", "chcete",
  "jste si jisti?"). This applies everywhere, including statistics and BAC copy.
...
| BAC / blood alcohol       | **odhad alkoholu v krvi** (level: "hladina alkoholu") |                |

## Do-not-translate (keep verbatim)

`Kiroku`, `Kiroku Supporter` (tier name), `OK`, `N/A`, `Google`, `Apple`,
`App Store`, `Google Play`, `TestFlight`, `Discord`, `QR`, `Menu`, `Widmark`
(declines as "Widmarkův"), version prefix `v`, and any dev-only / test-tools
