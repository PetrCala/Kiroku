...
const LOGO_SHAPES: readonly LogoShape[] = [
  // Outline: pencil silhouette
  {
    d: 'M413.85 280.55 L720.46 357 L625.9 736.28 L426.72 882.03 L319.29 659.83 Z',
    fill: '#B0A488',
  },
  // Outline: foam cap
  {
    d: 'M459.42 238.32 L700.05 298.32 C722.56 303.93 736.26 326.72 730.65 349.23 L728.47 357.96 C722.86 380.47 700.06 394.16 677.56 388.55 L436.92 328.56 C414.42 322.94 400.72 300.15 406.33 277.64 L408.51 268.91 C414.12 246.4 436.91 232.71 459.42 238.32 Z',
    fill: '#B0A488',
  },
  // Outline: foam lobe L
  {
    d: 'M558.88 265.18 C548.99 304.83 508.83 328.96 469.17 319.08 C429.52 309.19 405.39 269.03 415.27 229.37 C425.16 189.72 465.32 165.59 504.98 175.47 C544.63 185.36 568.77 225.52 558.88 265.18 Z',
    fill: '#B0A488',
  },
  // Outline: foam lobe C
  {
    d: 'M670.45 268.26 C658.69 315.42 610.93 344.11 563.77 332.36 C516.61 320.6 487.92 272.84 499.67 225.68 C511.43 178.52 559.19 149.83 606.35 161.58 C653.51 173.34 682.2 221.1 670.45 268.26 Z',
    fill: '#B0A488',
  },
  // Outline: foam lobe R
  {
    d: 'M738.87 312.12 C729.52 349.63 691.53 372.45 654.01 363.1 C616.5 353.75 593.68 315.76 603.03 278.25 C612.38 240.73 650.37 217.91 687.88 227.26 C725.39 236.61 748.22 274.6 738.87 312.12 Z',
    fill: '#B0A488',
  },
  // Pencil body
  {
