  ...
  return (
    <View style={[styles.mh5, styles.mb5]}>
      <SkeletonViewContentLoader
        ...
        <Rect x={164} y={14} width={12} height={12} />
        <Rect x={184} y={16} width={52} height={8} />
        <Rect x={260} y={14} width={12} height={12} />
        <Rect x={280} y={16} width={40} height={8} />
      </SkeletonViewContentLoader>
      <View style={[styles.pAbsolute, styles.w100]}>
        <SkeletonViewContentLoader
          ...
          <Rect x={12} y={14} width={12} height={12} />
          <Rect x={32} y={16} width={24} height={8} />
        </SkeletonViewContentLoader>
      </View>
    </View>
  );
