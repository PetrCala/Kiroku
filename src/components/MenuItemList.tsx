      ...
      {menuItems.map(menuItemProps => (
        <MenuItem
          ...
          onSecondaryInteraction={
            menuItemProps.link !== undefined
              ? e => secondaryInteraction(menuItemProps.link, e)
              : undefined
          }
          ref={popoverAnchor}
          ...
          onPress={
            shouldUseSingleExecution
              ? singleExecution(menuItemProps.onPress)
              : menuItemProps.onPress
          }
        />
      ))}
    </>
