...
const ScreenWrapperStatusContext = createContext({
...
function ScreenWrapper(
  ...
  const minHeight =
    shouldEnableMinHeight && !Browser.isSafari() ? initialHeight : undefined;
              ...
              <KeyboardAvoidingView
                style={[
                  ...
                  isAvoidingViewportScroll
                    ? [styles.overflowAuto, styles.overscrollBehaviorContain]
                    : {},
                ]}
