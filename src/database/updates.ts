 ...
 * @param differences - An array of differences generated by comparing two objects.
 * @returns - A nested object representing the updates.
 */
 ...
 * @param updates - The nested object containing updates.
 * @param [basePath=''] - An optional base path to prepend to all output keys.
 * @returns - A flattened object with database paths as keys and update values.
 */
 ...
 *
 * @template T - The type of the objects being compared.
 * @param lhs - The original object (left-hand side).
 * @param rhs - The updated object (right-hand side).
 * @param basePath - An optional base path to prepend to all output keys.
 * @returns - A flattened object with database paths as keys and update values.
 */
